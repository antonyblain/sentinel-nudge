...
- **P-016** — La clé AES absente (storage purgé, premier réveil post-install raté) rendait M7 muet sans aucun signal visible. _Fail silent = fail open_ en sécurité.
...
| DAT P3                    | `docs/p3-architecture/p3-dat-v1.3.md` (anciennement v1.1, renommé en v1.3 lors de TACHE-071)          |
